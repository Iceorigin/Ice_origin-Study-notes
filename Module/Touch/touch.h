...
//电阻屏芯片连接引脚	   
#define PEN     PFin(10)    //T_PEN  笔中断
#define DOUT    PBin(2)    	//T_MISO 主接收 从输出
#define TDIN    PFout(9)   	//T_MOSI 主输出 从接收
#define TCLK    PBout(1)   	//T_SCK  时钟线
#define TCS     PFout(11)   //T_CS    片选 1为主机 0从机
