...
//由于内存管理表为u16类型 因此一次性最大申请内存块为65,535个 #1个2字节数组管理32字节内存块
//所以管理MEM_MAX_SIZE大小的内存，总共所需内存大小为（字节）：MEMx_MAX_SIZE + MEMx_ALLOC_TABLE_SIZE * 2 
...
#define MEM2_MAX_SIZE			  768 *1024  					             	//最大管理内存768K字节
